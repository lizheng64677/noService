	    ...
	    <input type="hidden" name="reply_is_use" id="reply_is_use"  value="1"/>
	    	<table cellpadding="3">
	    		...
	    		<tr>
	    			...
	    			<td>
	    				<input   class="easyui-textbox" type="text"  style="width:300px;height:30px;" name="keywords" ></input>
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>标题:</td>
	    			<td>
	    				<input class="easyui-textbox" type="text"  style="width:300px;height:70px;" name="title" ></input>
	    			</td>
	    		</tr>
	    		<tr class="messageImage">
	    			<td>点击图文跳转链接:</td>
	    			<td><input class="easyui-textbox" type="text"  style="width:300px;height:30px;" name="url" ></input></td>
	    		</tr>
	    		<tr class="messageImage">
	    			<td>图片地址:</td>
	    			<td>
	    				<img id="img"  width="120" height="60" src=""/>
...
$(function(){
	...
	$("#subDataForm").click(function(){ 
		...
		var url="<c:url value='/weChatReply/addWeChatReply'/>";
		$.ajax({
			type : 'POST',
			url : url,
