...
<body>
	<div class="easyui-panel" title="添加"   style="padding:10px;">
	    ...
	    <form id="dataForm"  method="post">
	    	...
	    	<table cellpadding="3">
	    		<input type="hidden" name="expType" value="2"/> <!--兑换式 -->
	    		<tr>
	    			<td>活动标题:</td>
	    		...
	    		<tr>
		    		<td>单位发券(天数):</td>
		    		<td>
		    		<input type="text"  name="unitDay" id="unitDay" class="easyui-validatebox input"  missingMessage="请填写单位天数" data-options="required:true" /><span style="color:red;">*整数</span>
		    		</td>
	    		</tr>
	...
	<script>
		...
		function submitForm(){
			...
			url="<c:url value='/expduihuan/add'/>";
