...
<body>
	<div class="easyui-panel" title="编辑"   style="padding:10px;">
	    ...
	    <form id="dataForm"  method="post">
	    	...
	    	<input type="hidden" name="expType" value="${experience.expType }"/> <!--兑换式 -->
	    	<table cellpadding="3">
	    		<tr>
	    			<td>活动标题:</td>
	    		...
	    		<select name="type" class="input">
  					<option value="2" selected="selected">兑换式</option>
	    		</select>
	    		</td>
	    		</tr>
	    		...
	    		<td>活动时间：</td>
	    		<td>
	    		<input type="text" name="beginTime" placeholder="输入活动开始时间" id="beginTime" value="${experience.beginTime }"  class="input" style="width:145px;"/>
	    		<input type="text" name="endTime"  placeholder="输入活动结束时间" id="endTime" value="${experience.endTime }"   class="input" style="width:145px;"/>
	    		</td>
	    		</tr>
	    		<tr>
		    		<td>单位发券(天数):</td>
		    		<td>
		    		<input type="text"  name="unitDay" id="unitDay" value="${experience.unitDay }" class="easyui-validatebox input"  missingMessage="请填写单位天数" data-options="required:true" /><span style="color:red;">*整数</span>
		    		</td>
	    		</tr>
	...
	<script>
		function submitForm(){
			...
			url="<c:url value='/expduihuan/update'/>";
				...
				success: function(data) {
                   if(1==data.result){
                	   $.messager.alert("操作提示", "提交成功！", "info", function () {
                		   window.location.href="<c:url value='/expduihuan/index'/>";
                       });
