...
<body class="easyui-layout">
	...
	<div data-options="region:'north',split:false" style="height: 100px;">
		<div id="top">
			...
			<div class="toptitle">NO团网运维平台</div>
			<div id="topRight">
				<ul>
	...
	<div data-options="region:'south',split:false" style="height: 30px;">
		<div style="font-family:arial; font-size:12px;" class="footer_">Copyright © 2014-2015 All Rights Reserved 苏银科技-NO团网版权所有</div>
	</div>
	...
	<div data-options="region:'center'"
		...
		<div id="tabs" class="easyui-tabs" fit="true">
			...
			<input type="button" onclick="findUvChars();" value="查看UV数据"/>
			<div style="widht:100%;">				
