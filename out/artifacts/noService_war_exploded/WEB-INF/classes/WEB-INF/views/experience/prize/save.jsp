...
<body>
	<div class="easyui-panel" title="添加"   style="padding:10px;">
	    ...
	    <form id="dataForm"  method="post">
	    	...
	    	<table cellpadding="3">
	    		<input type="hidden" name="expType" value="0"/> <!--抽奖式 -->
	    		<tr>
	    			<td>活动标题:</td>
	    		...
	    		<tr>
		    		...
		    		<select name="showType" class="input">
			    		<option value="">---请选择---</option>
			    		<option value="0">红包方式</option>
			    		<option value="1">拼图方式</option>
			    		<option value="2">刮刮卡方式</option>
			    		<option value="3">抽签方式</option>
		    		</select>
		    		</td>
	    		</tr>
	    		<tr>
	    		...
	    		<tr>
		    		<td>中奖概率:</td>
		    		<td>
		    		<input type="text"  name="probability" class="easyui-validatebox input"  missingMessage="请填写中奖概率" data-options="required:true" />
		    		</td>
	    		</tr>
	...
	<script>
		...
		function submitForm(){
			...
			url="<c:url value='/experience/add'/>";
