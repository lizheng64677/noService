...
function initWx(expType){
	...
	$.ajax({
		type:"post",
		url:"/noService/sysLog/initExpZhuanData?clicentType=0&expType="+expType,
		dataType:"text",
...
function initAndriod(expType){
	...
	$.ajax({
		type:"post",
		url:"/noService/sysLog/initExpZhuanData?clicentType=2&expType="+expType,
		dataType:"text",
		success:function(json){
...
function initIos(expType){
	...
	$.ajax({
		type:"post",
		url:"/noService/sysLog/initExpZhuanData?clicentType=1&expType="+expType,
		dataType:"text",
		success:function(json){
...
function initWxUv(expType){
	...
	$.ajax({
		type:"post",
		url:"/noService/sysLog/initExpZhuanDataUv?clicentType=0&expType="+expType,
		dataType:"text",
		success:function(json){
...
function initAndriodUv(expType){
	...
	$.ajax({
		type:"post",
		url:"/noService/sysLog/initExpZhuanDataUv?clicentType=2&expType="+expType,
		dataType:"text",
		success:function(json){
...
function initIosUv(expType){
	...
	$.ajax({
		type:"post",
		url:"/noService/sysLog/initExpZhuanDataUv?clicentType=1&expType="+expType,
		dataType:"text",
		success:function(json){
