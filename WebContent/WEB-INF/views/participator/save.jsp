...
<body>
	<div class="easyui-panel" title="添加"   style="padding:10px;">
	    ...
	    <form id="dataForm"  method="post">
	    	<table cellpadding="3">
		    	...
		    	<tr>
		    		<td>年龄:</td>
		   			<td><input   class="easyui-textbox" type="text" style="width:300px;height:30px;"   missingMessage="填写年龄" name="age" data-options="required:false"></input></td>
		   		</tr>
	    		<tr>
	    			<td>编号:</td>
	...
	<script>
		function submitForm(){
			...
			url="<c:url value='/adminparticipator/add'/>";
