...
<body>
	<div class="easyui-panel" title="编辑"   style="padding:10px;">
	    ...
	    <form id="dataForm"  method="post">
	    	...
	    	<table cellpadding="3">
	    		<input type="hidden" value="${thememonth.themeId }" name="themeId"/>
	    		<tr>
	    			<td>主题标题:</td>
	    			<td><input    class="easyui-validatebox input" type="text" style="width:300px;height:30px;"  missingMessage="请输入主题标题" name="themeTitle" data-options="required:true" value="${thememonth.themeTitle}"></input></td>
	    		</tr>
	    		 <tr>
	    			<td>主题颜色:</td>
	    			<td><input    class="easyui-validatebox input color" type="text" style="width:300px;height:30px;"  missingMessage="请选择主题颜色" name="color" data-options="required:true" value="${thememonth.color}"></input></td>
	    		</tr>
	    		<tr>
	    			<td>主题月份:</td>
	    		...
	    		<td>主题LOGO:</td>
	    		<td>
	    			<img alt="" src="${thememonth.themeLogo }" id="themeLogoUrl" style="width:70px;height:70px">    			
					<input type="hidden" name="themeLogo" id="themeLogo" value="${thememonth.themeLogo }"> 
	    		...
	    		<td>主题图片:</td>
	    		<td>
	    			<img alt="主题图片" src="${thememonth.themePic }" id="themePicUrl" style="width:70px;height:70px">    			
					<input type="hidden" name="themePic" id="themePic" value="${thememonth.themePic }"> 
	    		...
	    		<td>底部图片:</td>
	    		<td>
	    			<img alt="底部图片" src="${thememonth.bottomPic }" id="bottomPicUrl" style="width:70px;height:70px">    			
					<input type="hidden" name="bottomPic" id="bottomPic" value="${thememonth.bottomPic }"> 
	...
	<script>
		function submitForm(){
			...
			url="<c:url value='/thememonth/update'/>";
