...
<body>
	    ...
	    <form id="dataForm"  method="post">
	    	...
	    	<table cellpadding="3">
	    		...
	    		<select name="type" class="input">
  					<option value="1" selected="selected">试用式</option>
	    		</select>
	    		</td>
	    		</tr>
	    		...
	    		<input type="text" name="endTime"  placeholder="输入活动结束时间" id="endTime" value="${experience.endTime }"   class="input" style="width:145px;"/>
		    		...
		    		<td>单位发券(天数):</td>
		    		<td>
		    		<input type="text"  name="unitDay" id="unitDay" class="easyui-validatebox input"  value="${experience.unitDay }"  missingMessage="请填写单位天数" data-options="required:true" /><span style="color:red;">*整数</span>
		    		</td>
	    		</tr>
	...
	<script>
		function submitForm(){
			...
			url="<c:url value='/expshiyong/update'/>";
				...
				success: function(data) {
                   if(1==data.result){
                	   $.messager.alert("操作提示", "提交成功！", "info", function () {
                		   window.location.href="<c:url value='/expshiyong/index'/>";
                       });
