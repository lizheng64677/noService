	    	...
	    	<table cellpadding="3">
	    		<tr>
	    			...
	    			<select class="input" name="memberId" id="memberId">
	    				...
	    				<option value="${m.memberId }">${m.busname }</option>
	    				</c:forEach>
	    			</select>
	    		...
	    		<tr>
		    		<td>兑换金币:</td>
		    		<td>
		    		<input type="text"  class="easyui-validatebox input"   missingMessage="请填写兑换金币数量"  data-options="required:true"  name="integral"/>
		    		</td>
	    		</tr>
	    		<tr>
	    			<td>券有效期:</td>
				...
				success: function(data) {
                   if(1==data.result){
                	   $.messager.alert("操作提示", "提交成功！", "info", function () {
                		   window.location.href="<c:url value='/expdetail/duiHuanIndex?expId=${expId }'/>"; 
                       });
