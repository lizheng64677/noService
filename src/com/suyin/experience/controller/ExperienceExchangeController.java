 ...
 * @author lz
 * @version 2015-9-8
 * @see ExperienceExchangeController
 * @since
 */
@Controller
@RequestMapping("/expduihuan")
public class ExperienceExchangeController{

    private final static Logger log=Logger.getLogger(ExperienceExchangeController.class);
    @Autowired
    ...
    public ModelAndView index() {
        ...
        return new ModelAndView("experience/exchange/index");
    }
    /**
     * 
     *  活动置顶操作
    ...
    public @ResponseBody Map<String, Object> findForExperienceAll(HttpServletRequest request) {
        ...
        {      
            ...
            entityInfo.setExpType(2); //0抽奖式，1人气式,2兑换式
    ...
    public ModelAndView jumpSetting(HttpServletRequest request,Experience exper) {
        ...
        return new ModelAndView("experience/exchange/setting",map);
    }
    ...
    public ModelAndView jumpExperienceAdd(HttpServletRequest request) {
        ...
        List<City>list=cityService.findCity(city);
        map.put("cityList",list);
        return new ModelAndView("experience/exchange/save",map);
    }
    ...
    public ModelAndView jumpExperienceEdit(HttpServletRequest request) {
        ...
        try
        {
            ...
            if(Tools.notEmpty(request.getParameter("id"))){  
                ...
                entity.setExpType(2); //0抽奖式，1人气式,2兑换式
        ...
        return new ModelAndView("experience/exchange/edit",map);
    }
