 ...
 * @author lz
 * @version 2015-9-6
 * @see ExpTaskTogetherController
 * @since
 */
@Controller
@RequestMapping("/expqixinzhuan")
public class ExpTaskTogetherController{

    private final static Logger log=Logger.getLogger(ExpTaskTogetherController.class);
    @Autowired
    ...
    public ModelAndView index() {
        ...
        return new ModelAndView("exptask/together/index");
    }
    ...
    public @ResponseBody Map<String, Object> findForExpZhuanAll(HttpServletRequest request) {
        ...
        {
            log.error("Controller Error ExpZhuanQxinController-> findExpZhuanByWhere  " + e.getMessage());
        }
    ...
    public @ResponseBody Map<String,Object> isBeg(HttpServletRequest request,ExpTask exper){
        ...
        catch (Exception e)
        {
            ...
            log.error("Controller Error ExpZhuanQxinController-> isBeg  " + e.getMessage());
        }
        return map;
    ...
    public ModelAndView jumpExpZhuanAdd(HttpServletRequest request) {
        ...
        map.put("cityList",list);
        Member m=new Member();
        List memberList=memberService.findMemberByPage(m);
        map.put("memberList",memberList);
        return new ModelAndView("exptask/together/save",map);
    }
...
//                attachment.setEntity(entity.getExpId());
//                List<Attachment> mentList=expZhuanService.findExpAttachmentByEntityExpId(attachment);
//                map.put("mentList", mentList);
        ...
        catch (Exception e)
        {
            ...
            log.error("Controller Error ExpZhuanQxinController-> jumpExpZhuanEdit  " + e.getMessage());
        }
        return new ModelAndView("exptask/together/edit",map);
    }
    ...
    public @ResponseBody Map<String, Object> saveExpZhuanInfo(ExpTask entity,HttpServletRequest request) {
        ...
        {
            log.error("Controller Error ExpZhuanQxinController-> saveExpZhuanInfo " + e.getMessage());
        }
        return map;
    }
    /**
    ...
    public @ResponseBody Map<String, Object> updateExpZhuanById(ExpTask entity,HttpServletRequest request) {
        ...
        {
            log.error("Controller Error ExpZhuanQxinController-> updateExpZhuanById  " + e.getMessage());
        }
        return map;
    }
    ...
    public @ResponseBody Map<String, Object> deleteExpZhuanById(String id) {
        ...
        try
        {
            if(Tools.notEmpty(id)){
                ...
                if(1==exper.getIsBegin()){
                    ...
                    expPrototypeService.deleteExpPrototype(exper.getExpId().toString());//删除对应动态属性
                    map.put("result",expZhuanService.deleteExpZhuan(id));
        ...
        {
            log.error("Controller Error ExpZhuanQxinController-> deleteExpZhuanById  " + e.getMessage());
        }
